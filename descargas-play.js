...
const texto1 = `*_𔓕꯭  ꯭ ꯭ ꯭ 𓏲꯭֟፝੭ ꯭HAYET BOT𓏲꯭֟፝੭ ꯭  ꯭ ꯭ ꯭𔓕_*
...
image: { url: yt_play[0].thumbnail }, caption: texto1, contextInfo: { externalAdReply: { title: '𝘿𝙚𝙨𝙘𝙖𝙧𝙜𝙖𝙨 ͜', body: 'TILIN VENTAS', sourceUrl: cn, thumbnail: logo7 }}, quoted: estilo});
try {
await m.react(rwait);
...
const yt_play = await search(args.join(' '));
const ytplay2 = await yts(text);
const texto1 = `*_𔓕꯭  ꯭ ꯭ ꯭ 𓏲꯭֟፝੭ ꯭HAYET BOT 𓏲꯭֟፝੭ ꯭  ꯭ ꯭ ꯭𔓕_*
...
await conn.sendMessage(m.chat, {
image: { url: yt_play[0].thumbnail }, caption: texto1, contextInfo: { externalAdReply: { title: '𝘿𝙚𝙨𝙘𝙖𝙧𝙜𝙖𝙨 ', body: 'TILIN VENTAS', sourceUrl: cn, thumbnail: logo7 }}, quoted: estilo});
try {
await m.react(rwait);
const apiUrl = `https://deliriussapi-oficial.vercel.app/download/ytmp4?url=${encodeURIComponent(yt_play[0].url)}`;
const apiResponse = await fetch(apiUrl);
...
await conn.sendMessage(m.chat, {
image: { url: yt_play[0].thumbnail }, caption: texto1, contextInfo: { externalAdReply: { title: '𝘿𝙚𝙨𝙘𝙖𝙧𝙜𝙖S ', body: 'TILIN VENTAS', sourceUrl: cn, thumbnail: logo7 }}, quoted: estilo});
try {
await m.react(rwait);
const apiUrl = `https://deliriussapi-oficial.vercel.app/download/ytmp4?url=${encodeURIComponent(yt_play[0].url)}`;
const apiResponse = await fetch(apiUrl);
